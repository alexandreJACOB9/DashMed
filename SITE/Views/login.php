...
<main class="main">
  <section class="hero">
    ...
    <form class="form" action="/login" method="post" novalidate>
      ...
      <p class="muted small mt-16">Pas de compte ? <a href="/register" class="link-strong">Inscrivez-vous</a></p>
      <p class="muted small">ou</p>
      <p class="small"><a href="/forgotten-password" class="link-strong">Mot de passe oublié ?</a></p>
    </form>
  </section>
</main>
